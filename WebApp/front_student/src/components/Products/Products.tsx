...
import { getProducts } from '../../store/actions/products.api.actions';
...
const Products: React.FC = () => {
  ...
  const account = useSelector((state: IStateType) => state.account);
  ...
  return (
    <Fragment>
      ...
      <div className="row">
          ...
          <div className="card shadow mb-4">
              ...
              <div className="header-buttons">
                ...
                <button className="btn btn-success btn-blue" onClick={() => {
                  if (!products.selectedProduct) {
                    dispatch(addNotification('Error', 'Please select a product to edit'));
                    return;
                  }
        ...
        {(account.role === 'ADMIN' && ((products.modificationState === ProductModificationStatus.Create)
