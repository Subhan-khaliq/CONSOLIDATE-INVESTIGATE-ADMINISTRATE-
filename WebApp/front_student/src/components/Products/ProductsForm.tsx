...
import { clearSelectedProduct, setModificationState } from "../../store/actions/products.action";
import { createProduct, updateProduct } from '../../store/actions/products.api.actions';
...
const ProductForm: React.FC = () => {
  ...
  function saveForm(formState: IProductFormState): void {
    if (product) {
      const payload = {
        ...product,
      ...
      dispatch(addNotification("Product saved", `Product ${formState.name.value} saved by you`));
